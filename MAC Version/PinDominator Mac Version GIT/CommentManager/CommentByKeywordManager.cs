...
namespace CommentManager
{
	...
	public delegate void CommentByKeywordAccount(int AccCount);
    public class CommentByKeywordManager
    {
        public static AccountReport_CommentByKeyword objCommentByKeywordDelegate;
		public static CommentByKeywordAccount objDelegateNoOfActiveAcc_CommentByKeyword;
		public static CommentByKeywordAccount objDelegateNoOfDeadAcc_CommentByKeyword;
                    ...
                    try
                    {
                        ...
                        if (!objPinUser.isloggedin)
                        {
                            ...
                            {                             
                                ...
                                if (!checkLogin)
                                {
									...
									DeadAccCount++;
									objDelegateNoOfDeadAcc_CommentByKeyword(DeadAccCount);
                                    return;
                                }
                        ...
                        if (objPinUser.isloggedin == true)
                        {
                            try
                            {
								...
								ActiveAccCount++;
								objDelegateNoOfActiveAcc_CommentByKeyword(ActiveAccCount);
                                ...
                                foreach (string KeywordsItem in Keywordarrray)
                                {
                                    lock (this)
                                    {
                                        try
                                        {
                                            ...
                                            string[] lstCommnet_strlist = Regex.Split(newItem, "::");
                                                ...
                                                try
                                                {
                                                    ...
                                                    {                                                      
                                                        ...
                                                        if (IsCommented)
                                                        {
                                                            ...
                                                            #endregion
                                                            counter++;
															GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Commneted on Pin : " + pin + " From " + objPinUser.Username + " ]");
                                                        ...
                                                        {
															GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Not Commneted on Pin : " + pin + " From " + objPinUser.Username + " ]");
                                                        }
