...
namespace CommentManager
{
	...
	public delegate void CommentAccount(int AccCount);
    ...
    public class CommentManagers
    {
		...
		public static CommentAccount objDelegateNoOfActiveAcc;
		public static CommentAccount objDelegateNoOfDeadAcc;
