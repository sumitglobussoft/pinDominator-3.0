    ...
    public class ManageAccManager
    {
        ...
        public void ChangeEmail(string email ,ref PinInterestUser objPinEmail)
        {
            try
            {
				...
				GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Starting Email Update ]");
                try
                {
...
//                            objManageAccountDelegate();
							...
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Email Updated For : " + objPinEmail.Username + " ]");
                            ClGlobul.lstEmailManageAcc.Remove(email);
                        }
                        else
                        {
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Unable to Update Email : " + objPinEmail.Username + " ]");
                        }
                    }
                    catch (Exception ex)
                    { };
        ...
        public void changePassword(string newPassword,ref PinInterestUser objPinPwd)
        {
            try
            {
				...
				GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Starting Password Update ]");
                try
                {
...
//                            objManageAccountDelegate();
							...
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Password Updated For : " + objPinPwd.Username + " ]");
                            ClGlobul.lstPwdManageAcc.Remove(newPassword);
                        }
                        else
                        {
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Unable to Update Password : " + objPinPwd.Username + " ]");
                        }
        ...
        public void changeScreenName(string newScreenName, ref PinInterestUser objPinScr)
        {
            try
            {
				...
				GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Starting ScreenName Update ]");
                try
                {
                    ...
                    try
                    {
                        ...
                        {
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ ScreenName Updated For : " + objPinScr.Username + " ]");
                        }
                        else
                        {
							GlobusLogHelper.log.Info("[ " + DateTime.Now + " ] => [ Unable to Update ScreenName : " + objPinScr.Username + " ]");
                        }
