...
namespace ScraperManagers
{
    ...
    public class ScraperManager
    {
        ...
        public void StartScraperMultiThreaded()
        {
            ...
            finally
            {
				...
				GlobusLogHelper.log.Info("[ " + DateTime.Now + "] => [ Process Completed Please. Now you can export file ]");
        ...
        public List<string> GetUserFollower_new()
        {
            try
            {
				...
				GlobusLogHelper.log.Info("[ " + DateTime.Now + "] => [ Starting Extraction Of Followers For " + UserName + " ]");
	...
	//                                    objScraperDelegate();
			...
			GlobusLogHelper.log.Info("[ " + DateTime.Now + "] => [ Total  Followers : " + ClGlobul.lstTotalUserScraped.Count + " ]");
