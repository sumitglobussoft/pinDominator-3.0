...
namespace BoardManager
{
	...
	public delegate void AddUserToBoardAccount(int AccountCount);
    public class AddUsersToBoardManager
    {
        public static AccountReport_AddUserToBoard objAddUserToBoarddelegate;
		public static AddUserToBoardAccount objDelegateNoOfActiveAcc;
		public static AddUserToBoardAccount objDelegateNoOfDeadAcc;
