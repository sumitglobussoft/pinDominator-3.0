...
namespace BasePD
{
    public class PDGlobals
    {
        ...
        public static string Pindominator_Folder_Path = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\PinDominator3.0";
        public static string InviteSentPath = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\PinDominator3.0\\InviteSent.txt";

        //Scraper Module
        public static string UserScrapedFollower = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\PinDominator3.0\\UserScrapedFollowers.txt";
        public static string UserScrapedFollowing = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\PinDominator3.0\\UserScrapedFollowings.txt";

        //EditPinDescription
        public static string path_PinDescription = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\PinDominator3.0\\PinDescriptionReport.txt";     
